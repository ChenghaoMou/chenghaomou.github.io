...
## Thoughts
It is a neat extension to what people are already doing with hash embeddings but at the end of the day, if we were ever to build an ultimate multilingul model, CANINE probably still need more parameters at convolution level and longer sequence len
